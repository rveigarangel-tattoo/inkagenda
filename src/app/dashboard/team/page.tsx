...
export default function TeamPage() {
  ...
  if ((session?.user as any)?.role !== "ADMIN") {
    return <div className="flex flex-col items-center justify-center py-20 text-center"><Users className="w-12 h-12 text-[#333] mb-4" /><p className="text-[#666] text-sm">Acesso restrito ao administrador.</p></div>
  }
  ...
  return (
    <div className="space-y-4 max-w-2xl mx-auto lg:max-w-none">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm text-[#555]">{artists.length} membros</span>
      </div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {artist.role === "ADMIN" && <Star className="w-3.5 h-3.5 text-[#d4a853]" fill="currentColor" />}
                  </div>
