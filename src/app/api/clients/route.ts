...
export async function GET() {
  ...
  const clients = await prisma.client.findMany({ include: { appointments: { where: appointmentWhere, select: { price: true, status: true, date: true }, orderBy: { date: "desc" } } }, orderBy: { name: "asc" } })
